...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        Console.WriteLine("Número: {0} - Nombre: {1} - Fecha: {2}", est1.NumeroEstudiante, est1.Nombre,
            est1.FechaIngreso);
        Console.WriteLine("Número: {0} - Nombre: {1} - Fecha: {2}", est2.NumeroEstudiante, est2.Nombre,
            est2.FechaIngreso);
